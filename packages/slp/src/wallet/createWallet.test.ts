import { createSlpWallet } from "./createWallet.js";
import { WalletRequestI, delay, disconnectProviders, initProviders, walletFromId } from "mainnet-js";
import { WalletTypeEnum } from "mainnet-js";
import { InstallSlpMixins, RegTestSlp } from "./Slp.js";
...
describe(`Named Wallets`, () => {
  ...
  test("Get create a regtest wif wallet", async () => {
    ...
    let w3 = await createSlpWallet(req2);
